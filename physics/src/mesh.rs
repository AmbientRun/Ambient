...
use elements_std::{
    asset_cache::{AssetCache, AsyncAssetKey, AsyncAssetKeyExt, SyncAssetKeyExt}, download_asset::{AssetError, AssetsCacheDir, BytesFromUrlCachedPath, UrlString}, mesh::Mesh, sha256_digest
};
use glam::Vec3;
...
use physxx::{
    PxConvexFlag, PxConvexMesh, PxConvexMeshDesc, PxDefaultFileInputData, PxDefaultFileOutputStream, PxMeshFlag, PxTriangleMesh, PxTriangleMeshDesc
};
