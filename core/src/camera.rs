...
impl Projection {
    ...
    pub fn set_far(&mut self, new_far: f32) {
        *self = match self.clone() {
            Projection::Orthographic { rect, near, far } => Projection::Orthographic { rect, near, far: new_far },
            Projection::PerspectiveInfiniteReverse { fovy, aspect_ratio, near } => {
                Projection::Perspective { fovy, aspect_ratio, near, far: new_far }
            }
            Projection::Perspective { fovy, aspect_ratio, near, far } => Projection::Perspective { fovy, aspect_ratio, near, far: new_far },
