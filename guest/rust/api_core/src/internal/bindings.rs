                    ...
                    pub fn set_components(entity: EntityId,data: &Entity,){
                      ...
                      unsafe {
                        ...
                        pub mod entity{
                          ...
                          #[repr(C)]
                          #[derive(Copy, Clone)]
                          pub struct AnimationStackTransition {
                            /// Blend weight [0, 1]
                            pub weight: f32,
                            /// Duration in seconds
                            pub duration: f32,
                          }
                          impl core::fmt::Debug for AnimationStackTransition {
                            fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                              f.debug_struct("AnimationStackTransition").field("weight", &self.weight).field("duration", &self.duration).finish()
                            }
                          }
                          /// Variant of animation action stack that resets the start to current time and samples the animation.
                          #[repr(C)]
                          #[derive(Copy, Clone)]
                          pub struct AnimationStackStart {
                            /// Index into animation controller actions
                            pub action_index: u32,
                            /// Duration in seconds
                            pub speed: f32,
                          }
                          impl core::fmt::Debug for AnimationStackStart {
                            fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                              f.debug_struct("AnimationStackStart").field("action-index", &self.action_index).field("speed", &self.speed).finish()
                            }
                          }
                          ...
                          pub enum AnimationActionStack{
                            ...
                            Transition(AnimationStackTransition),
                          }
                          impl core::fmt::Debug for AnimationActionStack {
                            fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                              match self {
                                AnimationActionStack::Start(e) => {
                                  f.debug_tuple("AnimationActionStack::Start").field(e).finish()
                                }
                                ...
                                AnimationActionStack::Transition(e) => {
                                  f.debug_tuple("AnimationActionStack::Transition").field(e).finish()
                                }
                              }
                            }
                          }
                          ...
                          impl<'a,> core::fmt::Debug for AnimationAction<'a,> {
                            fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                              f.debug_struct("AnimationAction").field("clip-url", &self.clip_url).field("looping", &self.looping).finish()
                            }
                          }
                          ...
                          pub fn set_animation_action_stack(entity: EntityId,stack: &[AnimationActionStack],transition_duration: f32,){
                            ...
                            unsafe {
                              ...
                              let layout6 = alloc::Layout::from_size_align_unchecked(vec6.len() * 12, 4);
                              ...
                              for (i, e) in vec6.into_iter().enumerate() {
                                let base = result6 as i32 + (i as i32) * 12;
                                {
                                  match e {
                                    AnimationActionStack::Start(e) => {
                                      *((base + 0) as *mut u8) = (0i32) as u8;
                                      let AnimationStackStart{ action_index:action_index1, speed:speed1, } = e;
                                      *((base + 4) as *mut i32) = wit_bindgen::rt::as_i32(action_index1);
                                      *((base + 8) as *mut f32) = wit_bindgen::rt::as_f32(speed1);
                                    ...
                                    AnimationActionStack::SamplePercentage(e) => {
                                      *((base + 0) as *mut u8) = (2i32) as u8;
                                      let AnimationSamplePercentage{ action_index:action_index2, time_percentage:time_percentage2, } = e;
                                      *((base + 4) as *mut i32) = wit_bindgen::rt::as_i32(action_index2);
                                      *((base + 8) as *mut f32) = wit_bindgen::rt::as_f32(time_percentage2);
                                      
                                    },
                                    AnimationActionStack::SampleAbsolute(e) => {
                                      *((base + 0) as *mut u8) = (3i32) as u8;
                                      let AnimationSampleAbsolute{ action_index:action_index3, time_absolute:time_absolute3, } = e;
                                      *((base + 4) as *mut i32) = wit_bindgen::rt::as_i32(action_index3);
                                      *((base + 8) as *mut f32) = wit_bindgen::rt::as_f32(time_absolute3);
                                    ...
                                    AnimationActionStack::Blend(e) => {
                                      *((base + 0) as *mut u8) = (5i32) as u8;
                                      let AnimationStackBlend{ weight:weight4, mask:mask4, } = e;
                                      *((base + 4) as *mut f32) = wit_bindgen::rt::as_f32(weight4);
                                      *((base + 8) as *mut i32) = wit_bindgen::rt::as_i32(mask4);
                                      
                                    },
                                    AnimationActionStack::Transition(e) => {
                                      *((base + 0) as *mut u8) = (6i32) as u8;
                                      let AnimationStackTransition{ weight:weight5, duration:duration5, } = e;
                                      *((base + 4) as *mut f32) = wit_bindgen::rt::as_f32(weight5);
                                      *((base + 8) as *mut f32) = wit_bindgen::rt::as_f32(duration5);
                                ...
                                extern "C" {
                                  ...
                                  fn wit_import(
                                  _: i64, _: i64, _: i32, _: i32, _: f32, );
                                }
                                wit_import(wit_bindgen::rt::as_i64(id00), wit_bindgen::rt::as_i64(id10), result6 as i32, len6, wit_bindgen::rt::as_f32(transition_duration));
                                if layout6.size() != 0 {
                            ...
                            pub fn set_animation_binder_mask(entity: EntityId,mask: &[&str],){
                              ...
                              pub fn play_animation_action_index(entity: EntityId,index: u32,speed: f32,transition_duration: f32,){
                                ...
                                unsafe {
                                  ...
                                  #[link(wasm_import_module = "entity")]
                                  extern "C" {
                                    #[cfg_attr(target_arch = "wasm32", link_name = "play-animation-action-index")]
                                    #[cfg_attr(not(target_arch = "wasm32"), link_name = "entity_play-animation-action-index")]
                                    fn wit_import(
                                    _: i64, _: i64, _: i32, _: f32, _: f32, );
                                  }
                                  wit_import(wit_bindgen::rt::as_i64(id00), wit_bindgen::rt::as_i64(id10), wit_bindgen::rt::as_i32(index), wit_bindgen::rt::as_f32(speed), wit_bindgen::rt::as_f32(transition_duration));
                                }
                              }
                              #[allow(clippy::all)]
                                    ...
                                    pub fn set_animation_controller(entity: EntityId,animation_controller: AnimationController<'_,>,){
                                      ...
                                      unsafe {
                                        ...
                                        for (i, e) in vec4.into_iter().enumerate() {
                                          ...
                                          {
                                            let AnimationAction{ clip_url:clip_url2, looping:looping2, } = e;
                                            let vec3 = clip_url2;
                                            let ptr3 = vec3.as_ptr() as i32;
                                            let len3 = vec3.len() as i32;
