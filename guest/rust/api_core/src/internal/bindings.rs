                                    ...
                                    pub mod script{
                                      ...
                                      pub fn watch(url: &str,){
                                        ...
                                        unsafe {
                                          ...
                                          #[link(wasm_import_module = "script")]
                                          extern "C" {
                                            #[cfg_attr(target_arch = "wasm32", link_name = "watch")]
                                            #[cfg_attr(not(target_arch = "wasm32"), link_name = "script_watch")]
                                            fn wit_import(
                                            _: i32, _: i32, );
                                          }
                                          wit_import(ptr0, len0);
