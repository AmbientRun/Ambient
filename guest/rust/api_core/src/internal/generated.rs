    ...
    pub mod camera {
        ...
        pub mod concepts {
            ...
            pub fn make_camera() -> Entity {
                Entity::new()
                    .with_merge(crate::core::transform::concepts::make_transformable())
                    .with(crate::core::camera::components::near(), 0.1f32)
                    .with(
                        crate::core::camera::components::projection(),
                    ...
                    .with(
                        crate::core::camera::components::projection_view(),
                        Mat4::from_cols_array(&[
                            1f32, 0f32, 0f32, 0f32, 0f32, 1f32, 0f32, 0f32, 0f32, 0f32, 1f32, 0f32,
                            0f32, 0f32, 0f32, 1f32,
                        ]),
                    )
                    .with(crate::core::camera::components::active_camera(), 0f32)
                    .with(
                        crate::core::transform::components::local_to_world(),
                        Mat4::from_cols_array(&[
                            1f32, 0f32, 0f32, 0f32, 0f32, 1f32, 0f32, 0f32, 0f32, 0f32, 1f32, 0f32,
                            0f32, 0f32, 0f32, 1f32,
                        ]),
                    ...
                    .with(
                        crate::core::transform::components::inv_local_to_world(),
                        Mat4::from_cols_array(&[
                            1f32, 0f32, 0f32, 0f32, 0f32, 1f32, 0f32, 0f32, 0f32, 0f32, 1f32, 0f32,
                            0f32, 0f32, 0f32, 1f32,
                        ]),
            ...
            pub fn is_camera(id: EntityId) -> bool {
                crate::core::transform::concepts::is_transformable(id)
                    && entity::has_components(
                        id,
                        &[
                            &crate::core::camera::components::near(),
                            &crate::core::camera::components::projection(),
                            &crate::core::camera::components::projection_view(),
                            &crate::core::camera::components::active_camera(),
                            &crate::core::transform::components::local_to_world(),
                            &crate::core::transform::components::inv_local_to_world(),
                        ],
                    )
            ...
            pub fn make_perspective_common_camera() -> Entity {
                Entity::new()
                    .with_merge(crate::core::camera::concepts::make_camera())
                    .with(crate::core::camera::components::fovy(), 1f32)
                    .with(crate::core::camera::components::aspect_ratio(), 1f32)
            }
            #[doc = "Checks if the entity is a *Perspective Common Camera*.\n\nBase components for a perspective camera. Consider `perspective-camera` or `perspective-infinite-reverse-camera`.\n\n*Definition*:\n\n```ignore\n{\n  \"ambient/core/camera/fovy\": f32 = 1.0,\n  \"ambient/core/camera/aspect-ratio\": f32 = 1.0,\n  \"ambient/core/camera/camera\": { // Concept.\n    \"ambient/core/camera/near\": f32 = 0.1,\n    \"ambient/core/camera/projection\": Mat4 = Mat4 { x_axis: Vec4(1.0, 0.0, 0.0, 0.0), y_axis: Vec4(0.0, 1.0, 0.0, 0.0), z_axis: Vec4(0.0, 0.0, 1.0, 0.0), w_axis: Vec4(0.0, 0.0, 0.0, 1.0) },\n    \"ambient/core/camera/projection-view\": Mat4 = Mat4 { x_axis: Vec4(1.0, 0.0, 0.0, 0.0), y_axis: Vec4(0.0, 1.0, 0.0, 0.0), z_axis: Vec4(0.0, 0.0, 1.0, 0.0), w_axis: Vec4(0.0, 0.0, 0.0, 1.0) },\n    \"ambient/core/camera/active-camera\": f32 = 0.0,\n    \"ambient/core/transform/local-to-world\": Mat4 = Mat4 { x_axis: Vec4(1.0, 0.0, 0.0, 0.0), y_axis: Vec4(0.0, 1.0, 0.0, 0.0), z_axis: Vec4(0.0, 0.0, 1.0, 0.0), w_axis: Vec4(0.0, 0.0, 0.0, 1.0) },\n    \"ambient/core/transform/inv-local-to-world\": Mat4 = Mat4 { x_axis: Vec4(1.0, 0.0, 0.0, 0.0), y_axis: Vec4(0.0, 1.0, 0.0, 0.0), z_axis: Vec4(0.0, 0.0, 1.0, 0.0), w_axis: Vec4(0.0, 0.0, 0.0, 1.0) },\n    \"ambient/core/transform/transformable\": { // Concept.\n      \"ambient/core/transform/translation\": Vec3 = Vec3(0.0, 0.0, 0.0),\n      \"ambient/core/transform/rotation\": Quat = Quat(0.0, 0.0, 0.0, 1.0),\n      \"ambient/core/transform/scale\": Vec3 = Vec3(1.0, 1.0, 1.0),\n    },\n  },\n}\n```\n"]
            pub fn is_perspective_common_camera(id: EntityId) -> bool {
                crate::core::camera::concepts::is_camera(id)
                    && entity::has_components(
                        id,
                        &[
                            &crate::core::camera::components::fovy(),
                            &crate::core::camera::components::aspect_ratio(),
                        ],
                    )
            }
            ...
            pub fn make_perspective_camera() -> Entity {
                Entity::new()
                    .with_merge(crate::core::camera::concepts::make_perspective_common_camera())
                    .with(crate::core::camera::components::perspective(), ())
                    .with(crate::core::camera::components::far(), 1000f32)
            }
            #[doc = "Checks if the entity is a *Perspective Camera*.\n\nA perspective camera.\n\n*Definition*:\n\n```ignore\n{\n  \"ambient/core/camera/perspective\": () = (),\n  \"ambient/core/camera/far\": f32 = 1000.0,\n  \"ambient/core/camera/perspective-common-camera\": { // Concept.\n    \"ambient/core/camera/fovy\": f32 = 1.0,\n    \"ambient/core/camera/aspect-ratio\": f32 = 1.0,\n    \"ambient/core/camera/camera\": { // Concept.\n      \"ambient/core/camera/near\": f32 = 0.1,\n      \"ambient/core/camera/projection\": Mat4 = Mat4 { x_axis: Vec4(1.0, 0.0, 0.0, 0.0), y_axis: Vec4(0.0, 1.0, 0.0, 0.0), z_axis: Vec4(0.0, 0.0, 1.0, 0.0), w_axis: Vec4(0.0, 0.0, 0.0, 1.0) },\n      \"ambient/core/camera/projection-view\": Mat4 = Mat4 { x_axis: Vec4(1.0, 0.0, 0.0, 0.0), y_axis: Vec4(0.0, 1.0, 0.0, 0.0), z_axis: Vec4(0.0, 0.0, 1.0, 0.0), w_axis: Vec4(0.0, 0.0, 0.0, 1.0) },\n      \"ambient/core/camera/active-camera\": f32 = 0.0,\n      \"ambient/core/transform/local-to-world\": Mat4 = Mat4 { x_axis: Vec4(1.0, 0.0, 0.0, 0.0), y_axis: Vec4(0.0, 1.0, 0.0, 0.0), z_axis: Vec4(0.0, 0.0, 1.0, 0.0), w_axis: Vec4(0.0, 0.0, 0.0, 1.0) },\n      \"ambient/core/transform/inv-local-to-world\": Mat4 = Mat4 { x_axis: Vec4(1.0, 0.0, 0.0, 0.0), y_axis: Vec4(0.0, 1.0, 0.0, 0.0), z_axis: Vec4(0.0, 0.0, 1.0, 0.0), w_axis: Vec4(0.0, 0.0, 0.0, 1.0) },\n      \"ambient/core/transform/transformable\": { // Concept.\n        \"ambient/core/transform/translation\": Vec3 = Vec3(0.0, 0.0, 0.0),\n        \"ambient/core/transform/rotation\": Quat = Quat(0.0, 0.0, 0.0, 1.0),\n        \"ambient/core/transform/scale\": Vec3 = Vec3(1.0, 1.0, 1.0),\n      },\n    },\n  },\n}\n```\n"]
            pub fn is_perspective_camera(id: EntityId) -> bool {
                crate::core::camera::concepts::is_perspective_common_camera(id)
                    && entity::has_components(
                        id,
                        &[
                            &crate::core::camera::components::perspective(),
                            &crate::core::camera::components::far(),
                        ],
                    )
            }
            ...
            pub fn make_perspective_infinite_reverse_camera() -> Entity {
                Entity::new()
                    .with_merge(crate::core::camera::concepts::make_perspective_common_camera())
                    .with(
                        crate::core::camera::components::perspective_infinite_reverse(),
                        (),
                    )
            }
            ...
            pub fn make_orthographic_camera() -> Entity {
                Entity::new()
                    .with_merge(crate::core::camera::concepts::make_camera())
                    .with(crate::core::camera::components::orthographic(), ())
                    .with(crate::core::camera::components::orthographic_left(), -1f32)
                    .with(crate::core::camera::components::orthographic_right(), 1f32)
                    .with(crate::core::camera::components::orthographic_top(), 1f32)
                    .with(
                        crate::core::camera::components::orthographic_bottom(),
                        -1f32,
                    )
                    .with(crate::core::camera::components::near(), -1f32)
                    .with(crate::core::camera::components::far(), 1f32)
            }
            ...
            pub fn is_orthographic_camera(id: EntityId) -> bool {
                crate::core::camera::concepts::is_camera(id)
                    && entity::has_components(
                        id,
                        &[
                            &crate::core::camera::components::orthographic(),
                            &crate::core::camera::components::orthographic_left(),
                            &crate::core::camera::components::orthographic_right(),
                            &crate::core::camera::components::orthographic_top(),
                            &crate::core::camera::components::orthographic_bottom(),
                            &crate::core::camera::components::near(),
                            &crate::core::camera::components::far(),
                        ],
    ...
    pub mod primitives {
        ...
        pub mod concepts {
            ...
            pub fn make_sphere() -> Entity {
                Entity::new()
                    .with(crate::core::primitives::components::sphere(), ())
                    .with(crate::core::primitives::components::sphere_radius(), 0.5f32)
                    .with(crate::core::primitives::components::sphere_sectors(), 36u32)
                    .with(crate::core::primitives::components::sphere_stacks(), 18u32)
            }
            ...
            pub fn is_sphere(id: EntityId) -> bool {
                entity::has_components(
                    id,
                    &[
                        &crate::core::primitives::components::sphere(),
                        &crate::core::primitives::components::sphere_radius(),
                        &crate::core::primitives::components::sphere_sectors(),
                        &crate::core::primitives::components::sphere_stacks(),
                    ],
                )
            }
            ...
            pub fn make_capsule() -> Entity {
                Entity::new()
                    .with(crate::core::primitives::components::capsule(), ())
                    .with(
                        crate::core::primitives::components::capsule_radius(),
                        0.5f32,
                    )
                    .with(
                        crate::core::primitives::components::capsule_half_height(),
                        0.5f32,
                    )
                    .with(crate::core::primitives::components::capsule_rings(), 0u32)
                    .with(
                        crate::core::primitives::components::capsule_latitudes(),
                        16u32,
                    )
                    .with(
                        crate::core::primitives::components::capsule_longitudes(),
                        32u32,
                    )
            }
            ...
            pub fn is_capsule(id: EntityId) -> bool {
                entity::has_components(
                    id,
                    &[
                        &crate::core::primitives::components::capsule(),
                        &crate::core::primitives::components::capsule_radius(),
                        &crate::core::primitives::components::capsule_half_height(),
                        &crate::core::primitives::components::capsule_rings(),
                        &crate::core::primitives::components::capsule_latitudes(),
                        &crate::core::primitives::components::capsule_longitudes(),
                    ],
                )
            ...
            pub fn make_torus() -> Entity {
                Entity::new()
                    .with(crate::core::primitives::components::torus(), ())
                    .with(
                        crate::core::primitives::components::torus_inner_radius(),
                        0.25f32,
                    )
                    .with(
                        crate::core::primitives::components::torus_outer_radius(),
                        0.35f32,
                    )
                    .with(crate::core::primitives::components::torus_slices(), 32u32)
                    .with(crate::core::primitives::components::torus_loops(), 16u32)
            }
            ...
            pub fn is_torus(id: EntityId) -> bool {
                entity::has_components(
                    id,
                    &[
                        &crate::core::primitives::components::torus(),
                        &crate::core::primitives::components::torus_inner_radius(),
                        &crate::core::primitives::components::torus_outer_radius(),
                        &crate::core::primitives::components::torus_slices(),
                        &crate::core::primitives::components::torus_loops(),
                    ],
                )
            }
    ...
    pub mod transform {
        ...
        pub mod concepts {
            ...
            pub fn make_transformable() -> Entity {
                Entity::new()
                    .with(
                        crate::core::transform::components::translation(),
                        Vec3::new(0f32, 0f32, 0f32),
                    )
                    .with(
                        crate::core::transform::components::rotation(),
                        Quat::from_xyzw(0f32, 0f32, 0f32, 1f32),
                    )
                    .with(
                        crate::core::transform::components::scale(),
