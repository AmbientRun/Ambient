    ...
    pub mod core {
        ...
        pub mod animation {
            ...
            static ANIMATION_ERRORS: Lazy<Component<Vec<String>>> =
                Lazy::new(|| __internal_get_component("ambient/core/animation/animation-errors"));
            ...
            static APPLY_ANIMATION_PLAYER: Lazy<Component<EntityId>> = Lazy::new(|| {
                __internal_get_component("ambient/core/animation/apply-animation-player")
            });
            ...
            static PLAY_CLIP_FROM_URL: Lazy<Component<String>> =
                Lazy::new(|| __internal_get_component("ambient/core/animation/play-clip-from-url"));
            ...
            static LOOPING: Lazy<Component<bool>> =
                Lazy::new(|| __internal_get_component("ambient/core/animation/looping"));
            ...
            static SPEED: Lazy<Component<f32>> =
                Lazy::new(|| __internal_get_component("ambient/core/animation/speed"));
            ...
            static START_TIME: Lazy<Component<Duration>> =
                Lazy::new(|| __internal_get_component("ambient/core/animation/start-time"));
            ...
            static FREEZE_AT_PERCENTAGE: Lazy<Component<f32>> = Lazy::new(|| {
                __internal_get_component("ambient/core/animation/freeze-at-percentage")
            });
            ...
            static FREEZE_AT_TIME: Lazy<Component<f32>> =
                Lazy::new(|| __internal_get_component("ambient/core/animation/freeze-at-time"));
            ...
            static CLIP_DURATION: Lazy<Component<f32>> =
                Lazy::new(|| __internal_get_component("ambient/core/animation/clip-duration"));
            ...
            static BLEND: Lazy<Component<f32>> =
                Lazy::new(|| __internal_get_component("ambient/core/animation/blend"));
            ...
            static MASK_BIND_IDS: Lazy<Component<Vec<String>>> =
                Lazy::new(|| __internal_get_component("ambient/core/animation/mask-bind-ids"));
            ...
            static MASK_WEIGHTS: Lazy<Component<Vec<f32>>> =
                Lazy::new(|| __internal_get_component("ambient/core/animation/mask-weights"));
            ...
            static RETARGET_MODEL_FROM_URL: Lazy<Component<String>> = Lazy::new(|| {
                __internal_get_component("ambient/core/animation/retarget-model-from-url")
            });
            ...
            static RETARGET_ANIMATION_SCALED: Lazy<Component<bool>> = Lazy::new(|| {
                __internal_get_component("ambient/core/animation/retarget-animation-scaled")
            });
        ...
        pub mod app {
            ...
            static DELTA_TIME: Lazy<Component<f32>> =
                Lazy::new(|| __internal_get_component("ambient/core/app/delta-time"));
            ...
            static EPOCH_TIME: Lazy<Component<Duration>> =
                Lazy::new(|| __internal_get_component("ambient/core/app/epoch-time"));
            ...
            static GAME_TIME: Lazy<Component<Duration>> =
                Lazy::new(|| __internal_get_component("ambient/core/app/game-time"));
            ...
            static ELEMENT: Lazy<Component<String>> =
                Lazy::new(|| __internal_get_component("ambient/core/app/element"));
            ...
            static ELEMENT_UNMANAGED_CHILDREN: Lazy<Component<()>> = Lazy::new(|| {
                __internal_get_component("ambient/core/app/element-unmanaged-children")
            });
            ...
            static MAIN_SCENE: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/app/main-scene"));
            ...
            static PROJECT_NAME: Lazy<Component<String>> =
                Lazy::new(|| __internal_get_component("ambient/core/app/project-name"));
            ...
            static SELECTABLE: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/app/selectable"));
            ...
            static SNAP_TO_GROUND: Lazy<Component<f32>> =
                Lazy::new(|| __internal_get_component("ambient/core/app/snap-to-ground"));
            ...
            static TAGS: Lazy<Component<Vec<String>>> =
                Lazy::new(|| __internal_get_component("ambient/core/app/tags"));
            #[doc = "**Tags**: Tags for categorizing this entity.\n\n*Attributes*: debuggable, networked, store"]
            pub fn tags() -> Component<Vec<String>> {
                *TAGS
            }
            static UI_SCENE: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/app/ui-scene"));
            ...
            static WINDOW_LOGICAL_SIZE: Lazy<Component<UVec2>> =
                Lazy::new(|| __internal_get_component("ambient/core/app/window-logical-size"));
            ...
            static WINDOW_PHYSICAL_SIZE: Lazy<Component<UVec2>> =
                Lazy::new(|| __internal_get_component("ambient/core/app/window-physical-size"));
            ...
            static WINDOW_SCALE_FACTOR: Lazy<Component<f64>> =
                Lazy::new(|| __internal_get_component("ambient/core/app/window-scale-factor"));
            ...
            static REF_COUNT: Lazy<Component<u32>> =
                Lazy::new(|| __internal_get_component("ambient/core/app/ref-count"));
        ...
        pub mod audio {
            ...
            static SPATIAL_AUDIO_PLAYER: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/audio/spatial-audio-player"));
            #[doc = "**Spatial audio player**: The entity is a spatial audio player.\n\n*Attributes*: maybe-resource, debuggable"]
            pub fn spatial_audio_player() -> Component<()> {
                *SPATIAL_AUDIO_PLAYER
            }
            static SPATIAL_AUDIO_EMITTER: Lazy<Component<EntityId>> =
                Lazy::new(|| __internal_get_component("ambient/core/audio/spatial-audio-emitter"));
            ...
            static SPATIAL_AUDIO_LISTENER: Lazy<Component<EntityId>> =
                Lazy::new(|| __internal_get_component("ambient/core/audio/spatial-audio-listener"));
            ...
            static LOOPING: Lazy<Component<bool>> =
                Lazy::new(|| __internal_get_component("ambient/core/audio/looping"));
            ...
            static HPF: Lazy<Component<Vec2>> =
                Lazy::new(|| __internal_get_component("ambient/core/audio/hpf"));
            ...
            static AUDIO_URL: Lazy<Component<String>> =
                Lazy::new(|| __internal_get_component("ambient/core/audio/audio-url"));
            #[doc = "**Audio URL**: The URL of the assets.\n\n\n\n*Attributes*: maybe-resource, debuggable"]
            pub fn audio_url() -> Component<String> {
                *AUDIO_URL
            }
            static PLAY_NOW: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/audio/play-now"));
            ...
            static STOP_NOW: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/audio/stop-now"));
        ...
        pub mod camera {
            ...
            static ASPECT_RATIO: Lazy<Component<f32>> =
                Lazy::new(|| __internal_get_component("ambient/core/camera/aspect-ratio"));
            ...
            static ASPECT_RATIO_FROM_WINDOW: Lazy<Component<EntityId>> = Lazy::new(|| {
                __internal_get_component("ambient/core/camera/aspect-ratio-from-window")
            });
            ...
            static NEAR: Lazy<Component<f32>> =
                Lazy::new(|| __internal_get_component("ambient/core/camera/near"));
            ...
            static ORTHOGRAPHIC: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/camera/orthographic"));
            ...
            static ORTHOGRAPHIC_BOTTOM: Lazy<Component<f32>> =
                Lazy::new(|| __internal_get_component("ambient/core/camera/orthographic-bottom"));
            ...
            static ORTHOGRAPHIC_FROM_WINDOW: Lazy<Component<EntityId>> = Lazy::new(|| {
                __internal_get_component("ambient/core/camera/orthographic-from-window")
            });
            ...
            static ORTHOGRAPHIC_LEFT: Lazy<Component<f32>> =
                Lazy::new(|| __internal_get_component("ambient/core/camera/orthographic-left"));
            ...
            static ORTHOGRAPHIC_RIGHT: Lazy<Component<f32>> =
                Lazy::new(|| __internal_get_component("ambient/core/camera/orthographic-right"));
            ...
            static ORTHOGRAPHIC_TOP: Lazy<Component<f32>> =
                Lazy::new(|| __internal_get_component("ambient/core/camera/orthographic-top"));
            ...
            static PERSPECTIVE: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/camera/perspective"));
            ...
            static PERSPECTIVE_INFINITE_REVERSE: Lazy<Component<()>> = Lazy::new(|| {
                __internal_get_component("ambient/core/camera/perspective-infinite-reverse")
            });
            ...
            static PROJECTION: Lazy<Component<Mat4>> =
                Lazy::new(|| __internal_get_component("ambient/core/camera/projection"));
            ...
            static PROJECTION_VIEW: Lazy<Component<Mat4>> =
                Lazy::new(|| __internal_get_component("ambient/core/camera/projection-view"));
            ...
            static SHADOWS_FAR: Lazy<Component<f32>> =
                Lazy::new(|| __internal_get_component("ambient/core/camera/shadows-far"));
        ...
        pub mod ecs {
            ...
            static DONT_DESPAWN_ON_UNLOAD: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/ecs/dont-despawn-on-unload"));
            ...
            static DONT_STORE: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/ecs/dont-store"));
            ...
            static ID: Lazy<Component<EntityId>> =
                Lazy::new(|| __internal_get_component("ambient/core/ecs/id"));
            #[doc = "**ID**: The ID of the entity.\n\n*Attributes*: debuggable, networked, store"]
            pub fn id() -> Component<EntityId> {
                *ID
            }
            static PARENT: Lazy<Component<EntityId>> =
                Lazy::new(|| __internal_get_component("ambient/core/ecs/parent"));
        ...
        pub mod input {
            ...
            static MOUSE_PICKABLE_MAX: Lazy<Component<Vec3>> =
                Lazy::new(|| __internal_get_component("ambient/core/input/mouse-pickable-max"));
            ...
            static MOUSE_PICKABLE_MIN: Lazy<Component<Vec3>> =
                Lazy::new(|| __internal_get_component("ambient/core/input/mouse-pickable-min"));
        ...
        pub mod layout {
            ...
            static MESH_TO_LOCAL_FROM_SIZE: Lazy<Component<()>> = Lazy::new(|| {
                __internal_get_component("ambient/core/layout/mesh-to-local-from-size")
            });
            ...
            static SPACE_BETWEEN_ITEMS: Lazy<Component<f32>> =
                Lazy::new(|| __internal_get_component("ambient/core/layout/space-between-items"));
        ...
        pub mod model {
            ...
            static MODEL_FROM_URL: Lazy<Component<String>> =
                Lazy::new(|| __internal_get_component("ambient/core/model/model-from-url"));
            ...
            static MODEL_LOADED: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/model/model-loaded"));
        ...
        pub mod network {
            ...
            static PERSISTENT_RESOURCES: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/network/persistent-resources"));
            ...
            static SYNCED_RESOURCES: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/network/synced-resources"));
        ...
        pub mod physics {
            ...
            static CUBE_COLLIDER: Lazy<Component<Vec3>> =
                Lazy::new(|| __internal_get_component("ambient/core/physics/cube-collider"));
            ...
            static CHARACTER_CONTROLLER_HEIGHT: Lazy<Component<f32>> = Lazy::new(|| {
                __internal_get_component("ambient/core/physics/character-controller-height")
            });
            ...
            static CHARACTER_CONTROLLER_RADIUS: Lazy<Component<f32>> = Lazy::new(|| {
                __internal_get_component("ambient/core/physics/character-controller-radius")
            });
            ...
            static COLLIDER_FROM_URL: Lazy<Component<String>> =
                Lazy::new(|| __internal_get_component("ambient/core/physics/collider-from-url"));
            ...
            static COLLIDER_LOADED: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/physics/collider-loaded"));
            ...
            static COLLIDER_LOADS: Lazy<Component<Vec<EntityId>>> =
                Lazy::new(|| __internal_get_component("ambient/core/physics/collider-loads"));
            ...
            static CONTACT_OFFSET: Lazy<Component<f32>> =
                Lazy::new(|| __internal_get_component("ambient/core/physics/contact-offset"));
            ...
            static DENSITY: Lazy<Component<f32>> =
                Lazy::new(|| __internal_get_component("ambient/core/physics/density"));
            ...
            static DYNAMIC: Lazy<Component<bool>> =
                Lazy::new(|| __internal_get_component("ambient/core/physics/dynamic"));
            ...
            static KINEMATIC: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/physics/kinematic"));
            ...
            static LINEAR_VELOCITY: Lazy<Component<Vec3>> =
                Lazy::new(|| __internal_get_component("ambient/core/physics/linear-velocity"));
            ...
            static MAKE_PHYSICS_STATIC: Lazy<Component<bool>> =
                Lazy::new(|| __internal_get_component("ambient/core/physics/make-physics-static"));
            ...
            static MASS: Lazy<Component<f32>> =
                Lazy::new(|| __internal_get_component("ambient/core/physics/mass"));
            #[doc = "**Mass**: The mass of this entity, measured in kilograms.\n\n*Attributes*: debuggable, networked, store\n\n*Suggested Default*: 1.0"]
            pub fn mass() -> Component<f32> {
                *MASS
            }
            static PHYSICS_CONTROLLED: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/physics/physics-controlled"));
            ...
            static REST_OFFSET: Lazy<Component<f32>> =
                Lazy::new(|| __internal_get_component("ambient/core/physics/rest-offset"));
            ...
            static SPHERE_COLLIDER: Lazy<Component<f32>> =
                Lazy::new(|| __internal_get_component("ambient/core/physics/sphere-collider"));
        ...
        pub mod player {
            ...
            static PLAYER: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/player/player"));
            ...
            static USER_ID: Lazy<Component<String>> =
                Lazy::new(|| __internal_get_component("ambient/core/player/user-id"));
        ...
        pub mod prefab {
            ...
            static SPAWNED: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/prefab/spawned"));
        ...
        pub mod primitives {
            ...
            static QUAD: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/primitives/quad"));
            ...
            static SPHERE: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/primitives/sphere"));
            ...
            static SPHERE_RADIUS: Lazy<Component<f32>> =
                Lazy::new(|| __internal_get_component("ambient/core/primitives/sphere-radius"));
            ...
            static SPHERE_SECTORS: Lazy<Component<u32>> =
                Lazy::new(|| __internal_get_component("ambient/core/primitives/sphere-sectors"));
            ...
            static SPHERE_STACKS: Lazy<Component<u32>> =
                Lazy::new(|| __internal_get_component("ambient/core/primitives/sphere-stacks"));
            ...
            static TORUS: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/primitives/torus"));
            ...
            static TORUS_INNER_RADIUS: Lazy<Component<f32>> = Lazy::new(|| {
                __internal_get_component("ambient/core/primitives/torus-inner-radius")
            });
            ...
            static TORUS_OUTER_RADIUS: Lazy<Component<f32>> = Lazy::new(|| {
                __internal_get_component("ambient/core/primitives/torus-outer-radius")
            });
            ...
            static TORUS_LOOPS: Lazy<Component<u32>> =
                Lazy::new(|| __internal_get_component("ambient/core/primitives/torus-loops"));
            ...
            static TORUS_SLICES: Lazy<Component<u32>> =
                Lazy::new(|| __internal_get_component("ambient/core/primitives/torus-slices"));
            ...
            static CAPSULE: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/primitives/capsule"));
            ...
            static CAPSULE_RADIUS: Lazy<Component<f32>> =
                Lazy::new(|| __internal_get_component("ambient/core/primitives/capsule-radius"));
            ...
            static CAPSULE_HALF_HEIGHT: Lazy<Component<f32>> = Lazy::new(|| {
                __internal_get_component("ambient/core/primitives/capsule-half-height")
            });
            ...
            static CAPSULE_RINGS: Lazy<Component<u32>> =
                Lazy::new(|| __internal_get_component("ambient/core/primitives/capsule-rings"));
            #[doc = "**Capsule rings**: Set the number of sections between the caps.\n\n*Attributes*: debuggable, networked, store"]
            pub fn capsule_rings() -> Component<u32> {
                *CAPSULE_RINGS
            }
            static CAPSULE_LATITUDES: Lazy<Component<u32>> =
                Lazy::new(|| __internal_get_component("ambient/core/primitives/capsule-latitudes"));
            ...
            static CAPSULE_LONGITUDES: Lazy<Component<u32>> = Lazy::new(|| {
                __internal_get_component("ambient/core/primitives/capsule-longitudes")
            });
        ...
        pub mod procedurals {
            ...
            static PROCEDURAL_MATERIAL: Lazy<Component<ProceduralMaterialHandle>> =
                Lazy::new(|| {
                    __internal_get_component("ambient/core/procedurals/procedural-material")
                });
        ...
        pub mod rect {
            ...
            static BACKGROUND_URL: Lazy<Component<String>> =
                Lazy::new(|| __internal_get_component("ambient/core/rect/background-url"));
            #[doc = "**Background URL**: URL to an image asset.\n\n*Attributes*: debuggable, networked, store"]
            pub fn background_url() -> Component<String> {
                *BACKGROUND_URL
            }
            static BORDER_COLOR: Lazy<Component<Vec4>> =
                Lazy::new(|| __internal_get_component("ambient/core/rect/border-color"));
            ...
            static BORDER_RADIUS: Lazy<Component<Vec4>> =
                Lazy::new(|| __internal_get_component("ambient/core/rect/border-radius"));
            ...
            static BORDER_THICKNESS: Lazy<Component<f32>> =
                Lazy::new(|| __internal_get_component("ambient/core/rect/border-thickness"));
            ...
            static SIZE_FROM_BACKGROUND_IMAGE: Lazy<Component<()>> = Lazy::new(|| {
                __internal_get_component("ambient/core/rect/size-from-background-image")
            });
        ...
        pub mod rendering {
            ...
            static COLOR: Lazy<Component<Vec4>> =
                Lazy::new(|| __internal_get_component("ambient/core/rendering/color"));
            ...
            static DOUBLE_SIDED: Lazy<Component<bool>> =
                Lazy::new(|| __internal_get_component("ambient/core/rendering/double-sided"));
            ...
            static FOG_COLOR: Lazy<Component<Vec3>> =
                Lazy::new(|| __internal_get_component("ambient/core/rendering/fog-color"));
            #[doc = "**Fog color**: The color of the fog for this `sun`.\n\n*Attributes*: debuggable, networked, store"]
            pub fn fog_color() -> Component<Vec3> {
                *FOG_COLOR
            }
            static FOG_DENSITY: Lazy<Component<f32>> =
                Lazy::new(|| __internal_get_component("ambient/core/rendering/fog-density"));
            #[doc = "**Fog density**: The density of the fog for this `sun`.\n\n*Attributes*: debuggable, networked, store"]
            pub fn fog_density() -> Component<f32> {
                *FOG_DENSITY
            }
            static FOG_HEIGHT_FALLOFF: Lazy<Component<f32>> =
                Lazy::new(|| __internal_get_component("ambient/core/rendering/fog-height-falloff"));
            ...
            static JOINT_MATRICES: Lazy<Component<Vec<Mat4>>> =
                Lazy::new(|| __internal_get_component("ambient/core/rendering/joint-matrices"));
            ...
            static JOINTS: Lazy<Component<Vec<EntityId>>> =
                Lazy::new(|| __internal_get_component("ambient/core/rendering/joints"));
            ...
            static LIGHT_AMBIENT: Lazy<Component<Vec3>> =
                Lazy::new(|| __internal_get_component("ambient/core/rendering/light-ambient"));
            ...
            static LIGHT_DIFFUSE: Lazy<Component<Vec3>> =
                Lazy::new(|| __internal_get_component("ambient/core/rendering/light-diffuse"));
            ...
            static OUTLINE: Lazy<Component<Vec4>> =
                Lazy::new(|| __internal_get_component("ambient/core/rendering/outline"));
            ...
            static OUTLINE_RECURSIVE: Lazy<Component<Vec4>> =
                Lazy::new(|| __internal_get_component("ambient/core/rendering/outline-recursive"));
            ...
            static OVERLAY: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/rendering/overlay"));
            ...
            static PBR_MATERIAL_FROM_URL: Lazy<Component<String>> = Lazy::new(|| {
                __internal_get_component("ambient/core/rendering/pbr-material-from-url")
            });
            ...
            static SKY: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/rendering/sky"));
            #[doc = "**Sky**: Add a realistic skybox to the scene.\n\n*Attributes*: debuggable, networked, store"]
            pub fn sky() -> Component<()> {
                *SKY
            }
            static SUN: Lazy<Component<f32>> =
                Lazy::new(|| __internal_get_component("ambient/core/rendering/sun"));
            ...
            static TRANSPARENCY_GROUP: Lazy<Component<i32>> =
                Lazy::new(|| __internal_get_component("ambient/core/rendering/transparency-group"));
            ...
            static WATER: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/rendering/water"));
            #[doc = "**Water**: Add a realistic water plane to this entity.\n\n*Attributes*: debuggable, networked, store"]
            pub fn water() -> Component<()> {
                *WATER
            }
            static DECAL_FROM_URL: Lazy<Component<String>> =
                Lazy::new(|| __internal_get_component("ambient/core/rendering/decal-from-url"));
            ...
            static SCISSORS: Lazy<Component<UVec4>> =
                Lazy::new(|| __internal_get_component("ambient/core/rendering/scissors"));
            ...
            static SCISSORS_RECURSIVE: Lazy<Component<UVec4>> =
                Lazy::new(|| __internal_get_component("ambient/core/rendering/scissors-recursive"));
        ...
        pub mod transform {
            ...
            static EULER_ROTATION: Lazy<Component<Vec3>> =
                Lazy::new(|| __internal_get_component("ambient/core/transform/euler-rotation"));
            #[doc = "**Euler rotation**: The Euler rotation of this entity in ZYX order.\n\n*Attributes*: debuggable, networked, store"]
            pub fn euler_rotation() -> Component<Vec3> {
                *EULER_ROTATION
            }
            static INV_LOCAL_TO_WORLD: Lazy<Component<Mat4>> =
                Lazy::new(|| __internal_get_component("ambient/core/transform/inv-local-to-world"));
            ...
            static LOCAL_TO_PARENT: Lazy<Component<Mat4>> =
                Lazy::new(|| __internal_get_component("ambient/core/transform/local-to-parent"));
            ...
            static LOCAL_TO_WORLD: Lazy<Component<Mat4>> =
                Lazy::new(|| __internal_get_component("ambient/core/transform/local-to-world"));
            ...
            static LOOKAT_TARGET: Lazy<Component<Vec3>> =
                Lazy::new(|| __internal_get_component("ambient/core/transform/lookat-target"));
            ...
            static LOOKAT_UP: Lazy<Component<Vec3>> =
                Lazy::new(|| __internal_get_component("ambient/core/transform/lookat-up"));
            ...
            static MESH_TO_LOCAL: Lazy<Component<Mat4>> =
                Lazy::new(|| __internal_get_component("ambient/core/transform/mesh-to-local"));
            ...
            static MESH_TO_WORLD: Lazy<Component<Mat4>> =
                Lazy::new(|| __internal_get_component("ambient/core/transform/mesh-to-world"));
            ...
            static RESET_SCALE: Lazy<Component<()>> =
                Lazy::new(|| __internal_get_component("ambient/core/transform/reset-scale"));
            ...
            static TRANSLATION: Lazy<Component<Vec3>> =
                Lazy::new(|| __internal_get_component("ambient/core/transform/translation"));
    ...
    pub mod core {
        ...
        pub mod camera {
            ...
            pub fn make_camera() -> Entity {
                Entity::new()
                    .with_merge(crate::concepts::core::transform::make_transformable())
                    .with(crate::components::core::camera::near(), 0.1f32)
                    .with(
                        crate::components::core::camera::projection(),
                    ...
                    .with(
                        crate::components::core::camera::projection_view(),
                        Mat4::from_cols_array(&[
                            1f32, 0f32, 0f32, 0f32, 0f32, 1f32, 0f32, 0f32, 0f32, 0f32, 1f32, 0f32,
                            0f32, 0f32, 0f32, 1f32,
                        ]),
                    )
                    .with(crate::components::core::camera::active_camera(), 0f32)
                    .with(
                        crate::components::core::transform::local_to_world(),
                        Mat4::from_cols_array(&[
                            1f32, 0f32, 0f32, 0f32, 0f32, 1f32, 0f32, 0f32, 0f32, 0f32, 1f32, 0f32,
                            0f32, 0f32, 0f32, 1f32,
                        ]),
                    ...
                    .with(
                        crate::components::core::transform::inv_local_to_world(),
                        Mat4::from_cols_array(&[
                            1f32, 0f32, 0f32, 0f32, 0f32, 1f32, 0f32, 0f32, 0f32, 0f32, 1f32, 0f32,
                            0f32, 0f32, 0f32, 1f32,
                        ]),
            ...
            pub fn is_camera(id: EntityId) -> bool {
                crate::concepts::core::transform::is_transformable(id)
                    && entity::has_components(
                        id,
                        &[
                            &crate::components::core::camera::near(),
                            &crate::components::core::camera::projection(),
                            &crate::components::core::camera::projection_view(),
                            &crate::components::core::camera::active_camera(),
                            &crate::components::core::transform::local_to_world(),
                            &crate::components::core::transform::inv_local_to_world(),
                        ],
                    )
            ...
            pub fn make_perspective_common_camera() -> Entity {
                Entity::new()
                    .with_merge(crate::concepts::core::camera::make_camera())
                    .with(crate::components::core::camera::fovy(), 1f32)
                    .with(crate::components::core::camera::aspect_ratio(), 1f32)
            }
            #[doc = "Checks if the entity is a *Perspective Common Camera*.\n\nBase components for a perspective camera. Consider `perspective-camera` or `perspective-infinite-reverse-camera`.\n\n*Definition*:\n\n```ignore\n{\n  \"ambient/core/camera/fovy\": f32 = 1.0,\n  \"ambient/core/camera/aspect-ratio\": f32 = 1.0,\n  \"ambient/core/camera/camera\": { // Concept.\n    \"ambient/core/camera/near\": f32 = 0.1,\n    \"ambient/core/camera/projection\": Mat4 = Mat4 { x_axis: Vec4(1.0, 0.0, 0.0, 0.0), y_axis: Vec4(0.0, 1.0, 0.0, 0.0), z_axis: Vec4(0.0, 0.0, 1.0, 0.0), w_axis: Vec4(0.0, 0.0, 0.0, 1.0) },\n    \"ambient/core/camera/projection-view\": Mat4 = Mat4 { x_axis: Vec4(1.0, 0.0, 0.0, 0.0), y_axis: Vec4(0.0, 1.0, 0.0, 0.0), z_axis: Vec4(0.0, 0.0, 1.0, 0.0), w_axis: Vec4(0.0, 0.0, 0.0, 1.0) },\n    \"ambient/core/camera/active-camera\": f32 = 0.0,\n    \"ambient/core/transform/local-to-world\": Mat4 = Mat4 { x_axis: Vec4(1.0, 0.0, 0.0, 0.0), y_axis: Vec4(0.0, 1.0, 0.0, 0.0), z_axis: Vec4(0.0, 0.0, 1.0, 0.0), w_axis: Vec4(0.0, 0.0, 0.0, 1.0) },\n    \"ambient/core/transform/inv-local-to-world\": Mat4 = Mat4 { x_axis: Vec4(1.0, 0.0, 0.0, 0.0), y_axis: Vec4(0.0, 1.0, 0.0, 0.0), z_axis: Vec4(0.0, 0.0, 1.0, 0.0), w_axis: Vec4(0.0, 0.0, 0.0, 1.0) },\n    \"ambient/core/transform/transformable\": { // Concept.\n      \"ambient/core/transform/translation\": Vec3 = Vec3(0.0, 0.0, 0.0),\n      \"ambient/core/transform/rotation\": Quat = Quat(0.0, 0.0, 0.0, 1.0),\n      \"ambient/core/transform/scale\": Vec3 = Vec3(1.0, 1.0, 1.0),\n    },\n  },\n}\n```\n"]
            pub fn is_perspective_common_camera(id: EntityId) -> bool {
                crate::concepts::core::camera::is_camera(id)
                    && entity::has_components(
                        id,
                        &[
                            &crate::components::core::camera::fovy(),
                            &crate::components::core::camera::aspect_ratio(),
                        ],
                    )
            }
            ...
            pub fn make_perspective_camera() -> Entity {
                Entity::new()
                    .with_merge(crate::concepts::core::camera::make_perspective_common_camera())
                    .with(crate::components::core::camera::perspective(), ())
                    .with(crate::components::core::camera::far(), 1000f32)
            }
            #[doc = "Checks if the entity is a *Perspective Camera*.\n\nA perspective camera.\n\n*Definition*:\n\n```ignore\n{\n  \"ambient/core/camera/perspective\": () = (),\n  \"ambient/core/camera/far\": f32 = 1000.0,\n  \"ambient/core/camera/perspective-common-camera\": { // Concept.\n    \"ambient/core/camera/fovy\": f32 = 1.0,\n    \"ambient/core/camera/aspect-ratio\": f32 = 1.0,\n    \"ambient/core/camera/camera\": { // Concept.\n      \"ambient/core/camera/near\": f32 = 0.1,\n      \"ambient/core/camera/projection\": Mat4 = Mat4 { x_axis: Vec4(1.0, 0.0, 0.0, 0.0), y_axis: Vec4(0.0, 1.0, 0.0, 0.0), z_axis: Vec4(0.0, 0.0, 1.0, 0.0), w_axis: Vec4(0.0, 0.0, 0.0, 1.0) },\n      \"ambient/core/camera/projection-view\": Mat4 = Mat4 { x_axis: Vec4(1.0, 0.0, 0.0, 0.0), y_axis: Vec4(0.0, 1.0, 0.0, 0.0), z_axis: Vec4(0.0, 0.0, 1.0, 0.0), w_axis: Vec4(0.0, 0.0, 0.0, 1.0) },\n      \"ambient/core/camera/active-camera\": f32 = 0.0,\n      \"ambient/core/transform/local-to-world\": Mat4 = Mat4 { x_axis: Vec4(1.0, 0.0, 0.0, 0.0), y_axis: Vec4(0.0, 1.0, 0.0, 0.0), z_axis: Vec4(0.0, 0.0, 1.0, 0.0), w_axis: Vec4(0.0, 0.0, 0.0, 1.0) },\n      \"ambient/core/transform/inv-local-to-world\": Mat4 = Mat4 { x_axis: Vec4(1.0, 0.0, 0.0, 0.0), y_axis: Vec4(0.0, 1.0, 0.0, 0.0), z_axis: Vec4(0.0, 0.0, 1.0, 0.0), w_axis: Vec4(0.0, 0.0, 0.0, 1.0) },\n      \"ambient/core/transform/transformable\": { // Concept.\n        \"ambient/core/transform/translation\": Vec3 = Vec3(0.0, 0.0, 0.0),\n        \"ambient/core/transform/rotation\": Quat = Quat(0.0, 0.0, 0.0, 1.0),\n        \"ambient/core/transform/scale\": Vec3 = Vec3(1.0, 1.0, 1.0),\n      },\n    },\n  },\n}\n```\n"]
            pub fn is_perspective_camera(id: EntityId) -> bool {
                crate::concepts::core::camera::is_perspective_common_camera(id)
                    && entity::has_components(
                        id,
                        &[
                            &crate::components::core::camera::perspective(),
                            &crate::components::core::camera::far(),
                        ],
                    )
            }
            ...
            pub fn make_perspective_infinite_reverse_camera() -> Entity {
                Entity::new()
                    .with_merge(crate::concepts::core::camera::make_perspective_common_camera())
                    .with(
                        crate::components::core::camera::perspective_infinite_reverse(),
                        (),
                    )
            }
            ...
            pub fn make_orthographic_camera() -> Entity {
                Entity::new()
                    .with_merge(crate::concepts::core::camera::make_camera())
                    .with(crate::components::core::camera::orthographic(), ())
                    .with(crate::components::core::camera::orthographic_left(), -1f32)
                    .with(crate::components::core::camera::orthographic_right(), 1f32)
                    .with(crate::components::core::camera::orthographic_top(), 1f32)
                    .with(
                        crate::components::core::camera::orthographic_bottom(),
                        -1f32,
                    )
                    .with(crate::components::core::camera::near(), -1f32)
                    .with(crate::components::core::camera::far(), 1f32)
            }
            ...
            pub fn is_orthographic_camera(id: EntityId) -> bool {
                crate::concepts::core::camera::is_camera(id)
                    && entity::has_components(
                        id,
                        &[
                            &crate::components::core::camera::orthographic(),
                            &crate::components::core::camera::orthographic_left(),
                            &crate::components::core::camera::orthographic_right(),
                            &crate::components::core::camera::orthographic_top(),
                            &crate::components::core::camera::orthographic_bottom(),
                            &crate::components::core::camera::near(),
                            &crate::components::core::camera::far(),
                        ],
        ...
        pub mod primitives {
            ...
            pub fn make_sphere() -> Entity {
                Entity::new()
                    .with(crate::components::core::primitives::sphere(), ())
                    .with(crate::components::core::primitives::sphere_radius(), 0.5f32)
                    .with(crate::components::core::primitives::sphere_sectors(), 36u32)
                    .with(crate::components::core::primitives::sphere_stacks(), 18u32)
            }
            ...
            pub fn is_sphere(id: EntityId) -> bool {
                entity::has_components(
                    id,
                    &[
                        &crate::components::core::primitives::sphere(),
                        &crate::components::core::primitives::sphere_radius(),
                        &crate::components::core::primitives::sphere_sectors(),
                        &crate::components::core::primitives::sphere_stacks(),
                    ],
                )
            }
            ...
            pub fn make_capsule() -> Entity {
                Entity::new()
                    .with(crate::components::core::primitives::capsule(), ())
                    .with(
                        crate::components::core::primitives::capsule_radius(),
                        0.5f32,
                    )
                    .with(
                        crate::components::core::primitives::capsule_half_height(),
                        0.5f32,
                    )
                    .with(crate::components::core::primitives::capsule_rings(), 0u32)
                    .with(
                        crate::components::core::primitives::capsule_latitudes(),
                        16u32,
                    )
                    .with(
                        crate::components::core::primitives::capsule_longitudes(),
                        32u32,
                    )
            }
            ...
            pub fn is_capsule(id: EntityId) -> bool {
                entity::has_components(
                    id,
                    &[
                        &crate::components::core::primitives::capsule(),
                        &crate::components::core::primitives::capsule_radius(),
                        &crate::components::core::primitives::capsule_half_height(),
                        &crate::components::core::primitives::capsule_rings(),
                        &crate::components::core::primitives::capsule_latitudes(),
                        &crate::components::core::primitives::capsule_longitudes(),
                    ],
                )
            ...
            pub fn make_torus() -> Entity {
                Entity::new()
                    .with(crate::components::core::primitives::torus(), ())
                    .with(
                        crate::components::core::primitives::torus_inner_radius(),
                        0.25f32,
                    )
                    .with(
                        crate::components::core::primitives::torus_outer_radius(),
                        0.35f32,
                    )
                    .with(crate::components::core::primitives::torus_slices(), 32u32)
                    .with(crate::components::core::primitives::torus_loops(), 16u32)
            }
            ...
            pub fn is_torus(id: EntityId) -> bool {
                entity::has_components(
                    id,
                    &[
                        &crate::components::core::primitives::torus(),
                        &crate::components::core::primitives::torus_inner_radius(),
                        &crate::components::core::primitives::torus_outer_radius(),
                        &crate::components::core::primitives::torus_slices(),
                        &crate::components::core::primitives::torus_loops(),
                    ],
                )
            }
        ...
        pub mod transform {
            ...
            pub fn make_transformable() -> Entity {
                Entity::new()
                    .with(
                        crate::components::core::transform::translation(),
                        Vec3::new(0f32, 0f32, 0f32),
                    )
                    .with(
                        crate::components::core::transform::rotation(),
                        Quat::from_xyzw(0f32, 0f32, 0f32, 1f32),
                    )
                    .with(
                        crate::components::core::transform::scale(),
