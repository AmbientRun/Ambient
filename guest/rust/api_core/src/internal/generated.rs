    ...
    pub mod ambient_core {
        ...
        pub mod camera {
            ...
            pub mod concepts {
                ...
                pub fn is_camera(world: &dyn crate::prelude::World, id: EntityId) -> bool {
        ...
        pub mod primitives {
            ...
            pub mod concepts {
                ...
                pub fn is_sphere(world: &dyn crate::prelude::World, id: EntityId) -> bool {
                    world.has_components(
                        id,
                        &[
                ...
                pub fn is_capsule(world: &dyn crate::prelude::World, id: EntityId) -> bool {
                    world.has_components(
                        id,
                        &[
                ...
                pub fn is_torus(world: &dyn crate::prelude::World, id: EntityId) -> bool {
                    world.has_components(
                        id,
                        &[
        ...
        pub mod transform {
            ...
            pub mod concepts {
                ...
                pub fn is_transformable(world: &dyn crate::prelude::World, id: EntityId) -> bool {
                    world.has_components(
                        id,
                        &[
                            &crate::ambient_core::transform::components::translation(),
