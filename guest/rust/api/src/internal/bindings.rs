                          ...
                          for (i, e) in vec50.into_iter().enumerate() {
                            ...
                            pub mod server_message{
                              ...
                              pub enum Target<'a,>{
                                ...
                                NetworkTargetedUnreliable(&'a str),
                                NetworkTargetedReliable(&'a str),
                                ModuleBroadcast,
                                Module(EntityId),
                              }
                                ...
                                fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                                  match self {
                                    Target::NetworkBroadcastUnreliable => {
                                      f.debug_tuple("Target::NetworkBroadcastUnreliable").finish()
                                    }
                                    Target::NetworkBroadcastReliable => {
                                      f.debug_tuple("Target::NetworkBroadcastReliable").finish()
                                    }
                                    Target::NetworkTargetedUnreliable(e) => {
                                      f.debug_tuple("Target::NetworkTargetedUnreliable").field(e).finish()
                                    }
                                    Target::NetworkTargetedReliable(e) => {
                                      f.debug_tuple("Target::NetworkTargetedReliable").field(e).finish()
                                    }
                                    Target::ModuleBroadcast => {
                                      f.debug_tuple("Target::ModuleBroadcast").finish()
                                    }
