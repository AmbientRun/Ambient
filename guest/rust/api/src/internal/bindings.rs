...
pub mod audio{
  ...
  #[allow(clippy::all)]
  pub fn play(name: &str,looping: bool,amp: f32,){
    ...
    unsafe {
      ...
      extern "C" {
        ...
        fn wit_import(
        _: i32, _: i32, _: i32, _: f32, );
      }
      wit_import(ptr0, len0, match looping { true => 1, false => 0 }, wit_bindgen::rt::as_f32(amp));
    }
  }
                          ...
                          for (i, e) in vec50.into_iter().enumerate() {
                            ...
                            pub mod client_input{
                              ...
                              impl core::fmt::Debug for Input {
                                fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                                  f.debug_struct("Input").field("keys", &self.keys).field("mouse-position", &self.mouse_position).field("cursor-position", &self.cursor_position).field("mouse-wheel", &self.mouse_wheel).field("mouse-buttons", &self.mouse_buttons).finish()
                                }
                              }
                              #[allow(clippy::all)]
                              pub fn get() -> Input{
                                ...
                                unsafe {
                                  ...
                                  Input{keys:result1, mouse_position:super::types::Vec2{x:*((ptr0 + 8) as *const f32), y:*((ptr0 + 12) as *const f32), }, cursor_position:super::types::Vec2{x:*((ptr0 + 16) as *const f32), y:*((ptr0 + 20) as *const f32), }, mouse_wheel:*((ptr0 + 24) as *const f32), mouse_buttons:result2, }
                                }
                              }
                              #[allow(clippy::all)]
                            ...
                            pub mod camera{
                              ...
                              pub type EntityId = super::types::EntityId;
                              #[allow(clippy::all)]
                              pub fn screen_ray(camera: EntityId,clip_space_pos: Vec2,) -> Ray{
