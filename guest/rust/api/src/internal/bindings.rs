                        ...
                        unsafe {
                          ...
                          for (i, e) in vec50.into_iter().enumerate() {
                            ...
                            pub mod camera{
                              ...
                              #[allow(clippy::all)]
                              pub fn screen_ray(clip_space_pos: Vec2,) -> Ray{
                                ...
                                unsafe {
                                  ...
                                  struct RetArea([u8; 24]);
                                  let mut ret_area = core::mem::MaybeUninit::<RetArea>::uninit();
                                  let super::types::Vec2{ x:x0, y:y0, } = clip_space_pos;
                                  let ptr1 = ret_area.as_mut_ptr() as i32;
                                  ...
                                  super::types::Ray{origin:super::types::Vec3{x:*((ptr1 + 0) as *const f32), y:*((ptr1 + 4) as *const f32), z:*((ptr1 + 8) as *const f32), }, dir:super::types::Vec3{x:*((ptr1 + 12) as *const f32), y:*((ptr1 + 16) as *const f32), z:*((ptr1 + 20) as *const f32), }, }
                                }
                              }
