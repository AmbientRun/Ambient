...
#[allow(missing_docs)] pub mod host { use super::wit_bindgen_guest_rust;
  ...
  impl core::fmt::Debug for PlayerRawInput {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
      f.debug_struct("PlayerRawInput").field("keys", &self.keys).field("mouse-position", &self.mouse_position).field("cursor-position", &self.cursor_position).field("mouse-wheel", &self.mouse_wheel).field("mouse-buttons", &self.mouse_buttons).finish()}
  }
  #[derive(Clone)]
  pub struct Query<'a,> {
                                        ...
                                        result21.push(match i32::from(*((base + 0) as *const u8)) {
                                          ...
                                          17 => ComponentTypeResult::TypeList(match i32::from(*((base + 8) as *const u8)) {
                                            ...
                                            1 => ComponentListTypeResult::TypeBool({
                                              ...
                                              if len3 != 0 {
                                                std::alloc::dealloc(base3 as *mut _, std::alloc::Layout::from_size_align_unchecked((len3 as usize) * 1, 1));
                                              }
                                            ...
                                            8 => ComponentListTypeResult::TypeString({
                                              ...
                                              for i in 0..len11 {
                                                ...
                                                result11.push({
                                                  ...
                                                  String::from_utf8(Vec::from_raw_parts(*((base + 0) as *const i32) as *mut _, len10, len10)).unwrap()
                                                });
                                              }
                                              if len11 != 0 {
                                                std::alloc::dealloc(base11 as *mut _, std::alloc::Layout::from_size_align_unchecked((len11 as usize) * 8, 4));
                                              }
                                ...
                                unsafe {
                                  ...
                                  match i32::from(*((ptr1 + 0) as *const u8)) {
                                    ...
                                    1 => Some({
                                      ...
                                      PlayerRawInput{keys:result2, mouse_position:Vec2{x:*((ptr1 + 12) as *const f32), y:*((ptr1 + 16) as *const f32), }, cursor_position:Vec2{x:*((ptr1 + 20) as *const f32), y:*((ptr1 + 24) as *const f32), }, mouse_wheel:*((ptr1 + 28) as *const f32), mouse_buttons:result3, }
                                    }),
                                    _ => panic!("invalid enum discriminant"),
                                  }
                                }
