...
pub mod audio{
  ...
  #[allow(clippy::all)]
  pub fn add_track(name: &str,url: &str,){
    ...
    unsafe {
      ...
      extern "C" {
        #[cfg_attr(target_arch = "wasm32", link_name = "add-track")]
        #[cfg_attr(not(target_arch = "wasm32"), link_name = "audio_add-track")]
        fn wit_import(
