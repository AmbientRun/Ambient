...
pub mod audio{
  ...
  #[allow(clippy::all)]
  pub fn play(name: &str,looping: bool,amp: f32,uid: u32,){
    ...
    unsafe {
      ...
      wit_import(ptr0, len0, match looping { true => 1, false => 0 }, wit_bindgen::rt::as_f32(amp), wit_bindgen::rt::as_i32(uid));
    }
  }
  #[allow(clippy::all)]
  pub fn stop(name: &str,){
    ...
    unsafe {
      ...
      extern "C" {
        ...
        #[cfg_attr(not(target_arch = "wasm32"), link_name = "audio_stop")]
        fn wit_import(
        _: i32, _: i32, );
      }
      wit_import(ptr0, len0);
  ...
  pub fn stop_by_id(uid: u32,){
    ...
    unsafe {
      ...
      extern "C" {
        ...
        #[cfg_attr(not(target_arch = "wasm32"), link_name = "audio_stop-by-id")]
        fn wit_import(
        _: i32, );
      }
  ...
  #[allow(clippy::all)]
  pub fn set_amp(name: &str,amp: f32,){
    ...
    unsafe {
      ...
      #[link(wasm_import_module = "audio")]
      extern "C" {
        #[cfg_attr(target_arch = "wasm32", link_name = "set-amp")]
        #[cfg_attr(not(target_arch = "wasm32"), link_name = "audio_set-amp")]
        fn wit_import(
        _: i32, _: i32, _: f32, );
      }
      wit_import(ptr0, len0, wit_bindgen::rt::as_f32(amp));
    }
  }
