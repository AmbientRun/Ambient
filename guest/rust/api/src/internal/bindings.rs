                                  ...
                                  pub mod server_physics{
                                    ...
                                    impl core::fmt::Debug for ForceMode {
                                      fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                                        match self {
                                          ForceMode::Force => {
                                            f.debug_tuple("ForceMode::Force").finish()
                                          }
                                          ForceMode::Impulse => {
                                            f.debug_tuple("ForceMode::Impulse").finish()
                                          }
                                          ForceMode::VelocityChange => {
                                            f.debug_tuple("ForceMode::VelocityChange").finish()
                                          }
                                          ForceMode::Acceleration => {
                                            f.debug_tuple("ForceMode::Acceleration").finish()
                                          }
                                        }
                                      }
                                    }
                                    ...
                                    pub fn apply_force(entity: EntityId,force: Vec3,mode: Option<ForceMode>,){
                                      ...
                                      unsafe {
                                        ...
                                        let (result2_0,result2_1,) = match mode {
                                          Some(e) => (1i32, match e {
                                            ForceMode::Force => 0,
                                            ForceMode::Impulse => 1,
                                        ...
                                        extern "C" {
                                          ...
                                          fn wit_import(
                                          _: i64, _: i64, _: f32, _: f32, _: f32, _: i32, _: i32, );
                                        }
                                        wit_import(wit_bindgen::rt::as_i64(id00), wit_bindgen::rt::as_i64(id10), wit_bindgen::rt::as_f32(x1), wit_bindgen::rt::as_f32(y1), wit_bindgen::rt::as_f32(z1), result2_0, result2_1);
                                      }
                                    }
                                    #[allow(clippy::all)]
                                    pub fn apply_force_at_position(entity: EntityId,force: Vec3,position: Vec3,mode: Option<ForceMode>,){
                                      ...
                                      unsafe {
                                        ...
                                        let (result3_0,result3_1,) = match mode {
                                          Some(e) => (1i32, match e {
                                            ForceMode::Force => 0,
                                            ForceMode::Impulse => 1,
                                            ForceMode::VelocityChange => 2,
                                        ...
                                        #[link(wasm_import_module = "server-physics")]
                                        extern "C" {
                                          #[cfg_attr(target_arch = "wasm32", link_name = "apply-force-at-position")]
                                          #[cfg_attr(not(target_arch = "wasm32"), link_name = "server-physics_apply-force-at-position")]
                                          fn wit_import(
                                          _: i64, _: i64, _: f32, _: f32, _: f32, _: f32, _: f32, _: f32, _: i32, _: i32, );
                                        }
                                        wit_import(wit_bindgen::rt::as_i64(id00), wit_bindgen::rt::as_i64(id10), wit_bindgen::rt::as_f32(x1), wit_bindgen::rt::as_f32(y1), wit_bindgen::rt::as_f32(z1), wit_bindgen::rt::as_f32(x2), wit_bindgen::rt::as_f32(y2), wit_bindgen::rt::as_f32(z2), result3_0, result3_1);
                                      }
                                    }
                                    #[allow(clippy::all)]
