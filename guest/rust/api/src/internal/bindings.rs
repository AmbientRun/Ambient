                          ...
                          for (i, e) in vec50.into_iter().enumerate() {
                            ...
                            pub mod server_message{
                              ...
                              pub enum Target<'a,>{
                                ...
                                PlayerTargetedUnreliable(&'a str),
                                PlayerTargetedReliable(&'a str),
                                ModuleBroadcast,
                                Module(EntityId),
                              }
