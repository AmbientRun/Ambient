...
mod raw {
    ...
    pub mod h3gv2vnpcajq75woh5nmiemeahfpaku4 {
        pub fn entity() -> ambient_api::global::EntityId {
            use ambient_api::once_cell::sync::Lazy;
            static ENTITY: Lazy<ambient_api::global::EntityId> = Lazy::new(|| {
                ambient_api::package::get_entity_for_package_id("h3gv2vnpcajq75woh5nmiemeahfpaku4")
                    .expect("Failed to get package entity - was it despawned?")
            });
            *ENTITY
        }
        ...
        pub mod components {
            ...
            static PLAYER_MOVEMENT_DIRECTION: Lazy<Component<f32>> = Lazy::new(|| {
                __internal_get_component(
                    "h3gv2vnpcajq75woh5nmiemeahfpaku4::player_movement_direction",
                )
            });
            ...
            static TRACK_AUDIO_URL: Lazy<Component<String>> = Lazy::new(|| {
                __internal_get_component("h3gv2vnpcajq75woh5nmiemeahfpaku4::track_audio_url")
            });
        ...
        pub mod messages {
            ...
            impl Input {
                ...
                pub fn new(direction: impl Into<f32>) -> Self {
                    Self {
            ...
            impl Message for Input {
                fn id() -> &'static str {
                    "h3gv2vnpcajq75woh5nmiemeahfpaku4::Input"
                }
            ...
            impl Message for Ping {
                fn id() -> &'static str {
                    "h3gv2vnpcajq75woh5nmiemeahfpaku4::Ping"
                }
                fn serialize_message(&self) -> Result<Vec<u8>, MessageSerdeError> {
                    let mut output = vec![];
                    Ok(output)
...
pub use raw::h3gv2vnpcajq75woh5nmiemeahfpaku4 as this;
