...
mod raw {
    pub mod n3xokyl3yn4vd3lzfjlvbbtgnnmqlnjo {
        pub fn entity() -> ambient_api::global::EntityId {
            ...
            static ENTITY: Lazy<ambient_api::global::EntityId> = Lazy::new(|| {
                ambient_api::package::get_entity_for_package_id("n3xokyl3yn4vd3lzfjlvbbtgnnmqlnjo")
...
pub use raw::n3xokyl3yn4vd3lzfjlvbbtgnnmqlnjo as this;
