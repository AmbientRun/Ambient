...
pub fn main() {
    Entity::new()
        ...
        .with(translation(), vec3(5.0, 5.0, 6.0))
        .with(lookat_target(), vec3(0.0, 0.0, 2.0))
        .spawn();
    ...
    Entity::new()
        ...
        .with(translation(), vec3(0.0, 2.0, 1.0))
        .with(color(), vec4(1.0, 0.0, 0.0, 1.0))
        .spawn();
    ...
    Entity::new()
        ...
        .with(sphere_sectors(), 12)
        .with(sphere_stacks(), 6)
        .with(translation(), vec3(1.0, 2.0, 0.75))
        .with(color(), vec4(0.0, 1.0, 0.0, 1.0))
        .spawn();
    ...
    //     .with_merge(make_transformable())
    //     .with_merge(make_sphere())
    //     .with(translation(), vec3(2.0, 2.0, 0.25))
