...
mod raw {
    ...
    pub mod znidkp3d3rqx7ir7bvs2ahx4sfrr2n7n {
        pub fn entity() -> ambient_api::global::EntityId {
            use ambient_api::once_cell::sync::Lazy;
            static ENTITY: Lazy<ambient_api::global::EntityId> = Lazy::new(|| {
                ambient_api::package::get_entity_for_package_id("znidkp3d3rqx7ir7bvs2ahx4sfrr2n7n")
                    .expect("Failed to get package entity - was it despawned?")
            });
            *ENTITY
        }
        ...
        pub mod messages {
            ...
            #[derive(Clone, Debug)]
            #[doc = "**SetController**: Sets the animation controller."]
            ...
            impl Message for SetController {
                fn id() -> &'static str {
                    "znidkp3d3rqx7ir7bvs2ahx4sfrr2n7n::SetController"
                }
                fn serialize_message(&self) -> Result<Vec<u8>, MessageSerdeError> {
                    let mut output = vec![];
                    self.value.serialize_message_part(&mut output)?;
                    Ok(output)
                }
                fn deserialize_message(mut input: &[u8]) -> Result<Self, MessageSerdeError> {
                    Ok(Self {
                        value: u32::deserialize_message_part(&mut input)?,
                    })
                }
            }
            impl ModuleMessage for SetController {}
        }
        #[doc = r" Helpers for accessing the assets for this package."]
        pub mod assets {
            pub fn url(path: &str) -> String {
...
pub use raw::znidkp3d3rqx7ir7bvs2ahx4sfrr2n7n as this;
