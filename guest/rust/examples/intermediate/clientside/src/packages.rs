...
mod raw {
    ...
    pub mod xz2ip2ptvxprurqwaiv2nncabcrmml2w {
        pub fn entity() -> ambient_api::global::EntityId {
            use ambient_api::once_cell::sync::Lazy;
            static ENTITY: Lazy<ambient_api::global::EntityId> = Lazy::new(|| {
                ambient_api::package::get_entity_for_package_id("xz2ip2ptvxprurqwaiv2nncabcrmml2w")
                    .expect("Failed to get package entity - was it despawned?")
            });
            *ENTITY
        }
        ...
        pub mod components {
            ...
            static GRID_SIDE_LENGTH: Lazy<Component<i32>> = Lazy::new(|| {
                __internal_get_component("xz2ip2ptvxprurqwaiv2nncabcrmml2w::grid_side_length")
            });
            #[doc = "**Grid Side Length**: The length of a grid side, ignoring the centre (i.e. if this is 10, the total axis length is 21)\n\n*Attributes*: Networked, Debuggable"]
            pub fn grid_side_length() -> Component<i32> {
                *GRID_SIDE_LENGTH
            }
            static GRID_POSITION: Lazy<Component<IVec2>> = Lazy::new(|| {
                __internal_get_component("xz2ip2ptvxprurqwaiv2nncabcrmml2w::grid_position")
            });
            #[doc = "**Grid Position**: The position of the cell on the grid\n\n*Attributes*: Networked, Debuggable"]
            pub fn grid_position() -> Component<IVec2> {
                *GRID_POSITION
            }
        }
        #[doc = r" Helpers for accessing the assets for this package."]
...
pub use raw::xz2ip2ptvxprurqwaiv2nncabcrmml2w as this;
