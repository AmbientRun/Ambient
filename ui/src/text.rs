        ...
        match self.0 {
            FontFamily::Default => {
                let font: &'static [u8] = match self.1 {
                    FontStyle::Bold => include_bytes!("../../assets/Ubuntu/Ubuntu Bold Nerd Font Complete.ttf"),
                    FontStyle::BoldItalic => include_bytes!("../../assets/Ubuntu/Ubuntu Bold Italic Nerd Font Complete.ttf"),
                    FontStyle::Italic => include_bytes!("../../assets/Ubuntu/Ubuntu Italic Nerd Font Complete.ttf"),
                    FontStyle::Light => include_bytes!("../../assets/Ubuntu/Ubuntu Light Nerd Font Complete.ttf"),
                    FontStyle::LightItalic => include_bytes!("../../assets/Ubuntu/Ubuntu Light Italic Nerd Font Complete.ttf"),
                    FontStyle::Medium => include_bytes!("../../assets/Ubuntu/Ubuntu Medium Nerd Font Complete.ttf"),
                    FontStyle::MediumItalic => include_bytes!("../../assets/Ubuntu/Ubuntu Medium Italic Nerd Font Complete.ttf"),
                    FontStyle::Regular => include_bytes!("../../assets/Ubuntu/Ubuntu Nerd Font Complete.ttf"),
                };
                Arc::new(FontArc::try_from_slice(font).unwrap())
            }
            FontFamily::FontAwesome { solid } => Arc::new(
                FontArc::try_from_slice(if solid {
                    include_bytes!("../../assets/Font Awesome 6 Free-Solid-900.otf")
                } else {
                    include_bytes!("../../assets/Font Awesome 6 Free-Regular-400.otf")
                })
                .unwrap(),
            ),
            FontFamily::SourceSansPro => {
                let font: &'static [u8] = match self.1 {
                    FontStyle::Bold => include_bytes!("../../assets/Source_Sans_Pro/SourceSansPro-Bold.ttf"),
                    FontStyle::BoldItalic => include_bytes!("../../assets/Source_Sans_Pro/SourceSansPro-BoldItalic.ttf"),
                    FontStyle::Italic => include_bytes!("../../assets/Source_Sans_Pro/SourceSansPro-Italic.ttf"),
                    FontStyle::Light => include_bytes!("../../assets/Source_Sans_Pro/SourceSansPro-Light.ttf"),
                    FontStyle::LightItalic => include_bytes!("../../assets/Source_Sans_Pro/SourceSansPro-LightItalic.ttf"),
                    FontStyle::Medium => include_bytes!("../../assets/Source_Sans_Pro/SourceSansPro-SemiBold.ttf"),
                    FontStyle::MediumItalic => include_bytes!("../../assets/Source_Sans_Pro/SourceSansPro-SemiBoldItalic.ttf"),
                    FontStyle::Regular => include_bytes!("../../assets/Source_Sans_Pro/SourceSansPro-Regular.ttf"),
                };
                Arc::new(FontArc::try_from_slice(font).unwrap())
            }
