...
components!("physics", {
    ...
    physics_controlled: (),
    @[Debuggable, Networked, Store, Name["Linear velocity"], Description["Linear velocity of this entity in the physics scene.\nUpdating this component will update the entity's linear velocity in the physics scene."]]
    linear_velocity: Vec3,
    @[Debuggable, Networked, Store, Name["Angular velocity"], Description["Angular velocity of this entity in the physics scene.\nUpdating this component will update the entity's angular velocity in the physics scene."]]
