...
pub struct ServerInfo {
    /// The name of the ember. Used by the client to figure out what to title its window. Defaults to "Ambient".
...
impl ServerInfo {
    pub fn new(state: &mut crate::server::ServerState, content_base_url: AbsAssetUrl) -> Self {
        ...
        Self {
            ember_name: world.resource(ember_name()).clone(),
            content_base_url,
