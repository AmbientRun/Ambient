...
fn simple_index_exact() {
    ...
    let x = world.spawn(Entity::new().with(a(), 5));
    index.insert_entity(&world, x);
    let dup = world.spawn(Entity::new().with(a(), 5));
...
fn multiple_for_exact_value() {
    ...
    let y = world.spawn(Entity::new().with(a(), 5));
    let z = world.spawn(Entity::new().with(a(), 5));
    let w = world.spawn(Entity::new().with(a(), 7));
    index.insert_entity(&world, x);
    index.insert_entity(&world, y);
    index.insert_entity(&world, z);
