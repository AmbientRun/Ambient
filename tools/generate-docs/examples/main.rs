...
fn generate_pipeline() -> anyhow::Result<()> {
    ...
    let mut file = std::fs::File::create("docs/src/reference/pipeline.d.ts")?;
    writeln!(file, "// This file is generated by the `generate-docs` tool. Please do not manually edit it.")?;
